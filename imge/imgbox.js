 ...
 * @LastEditTime: 2023-11-13 13:53:44
...
(function ($, window) {
    ...
    function _Miniimgbox(img_selector, container_selector, options) {
        ...
        function get_slide(each_this) {
            var thumbs_src = each_this.attr('box-src') || each_this.attr('box-src');
            var data_src = each_this.attr('box-src');
    ...
    tbquire(['swiper'], function () {
        ...
        Miniimgbox('.avatarbox_Miniimgbox,a[data-imgbox]');
