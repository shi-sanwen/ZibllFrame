 ...
 * @LastEditTime: 2023-11-12 19:35:12
...
function zib_get_avatar_box($user_id, $class = 'avatar-img', $link = true, $vip = true)
{
  ...
  $avatar_img =   get_avatarbox_user_toshi($user_id);
 }
...
function zib_get_avatar_badge($user_id = 0, $tip = 1)
{
    ...
    if ($vip_level) {
        ...
        $vip_badge = '<img ' . $lazy_attr . 'src="' . $vip_img_src . '"' . $tip_attr . ' style="z-index: 1;" title="' . _pz('pay_user_vip_' . $vip_level . '_name') . '" alt="' . _pz('pay_user_vip_' . $vip_level . '_name') . '">';
    }
